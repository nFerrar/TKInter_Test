...
class TranslateBook(tk.Tk):
    ...
    def translate(self, target_languages=None, text=None, elements=None):
        ...
        url = "https://translate.googleapis.com/translate_a/single?client=gtx&sl={}&tl={}&dt=t&q={}".format("en", target_languages, text)
    ...
    def add_portuguese_tab(self):
        ...
        self.portuguese_copy_button = tk.Button(portuguese_tab, text="Copy to Clipboard", command=self.copy_to_clipboard(self.portuguese_translation.get()))
